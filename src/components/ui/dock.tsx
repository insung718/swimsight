      ...
      <div className="pointer-events-auto flex max-w-[calc(100vw-1.5rem)] items-end gap-1.5 overflow-x-auto rounded-lg border border-white/25 bg-stitch-abyss/[0.86] px-2 py-2 shadow-stitch backdrop-blur-2xl sm:gap-2 sm:px-3" data-no-translate role="toolbar" aria-label={t("Dashboard dock")}>
        {items.map((item) => {
          ...
          <button
            ...
            className={cn(
              "group ui-press relative inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-md border text-white hover:-translate-y-1 hover:scale-[1.04] focus-visible:-translate-y-1 focus-visible:outline focus-visible:outline-2 focus-visible:outline-stitch-cyan sm:h-12 sm:w-12 sm:hover:-translate-y-1.5 sm:hover:scale-[1.08] sm:focus-visible:-translate-y-1.5",
              item.active
