  ...
  return (
    <section className="stitch-panel p-5">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <label className="text-sm text-white/80">{t("Goal date")}<input className="mt-1 h-11 w-full rounded-md border border-white/10 bg-stitch-abyss px-3 text-white outline-none focus:border-stitch-cyan" type="date" value={targetDate} onChange={(e) => setTargetDate(e.target.value)} /></label>
      </div>
